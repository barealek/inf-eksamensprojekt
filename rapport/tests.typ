...
Projektet kan køres med Dockerfilen, eller tilgås på https://inf-eksamensprojekt-production.up.railway.app/queues så længe den forbliver oppe. En konto eksisterer med navn `test` og kode `testkode`.
